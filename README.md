...
## Description
This is the code for the Museum of Virtual Arts (MoVA) in [Decentraland](https://decentraland.org), a flexible virtual structure for the exhibition of virtual 
...
MoVA will be placed in [Aetheria](http://aetheria.io), Decentraland ([jump in right here](https://play.decentraland.org/?position=104%2C146)). 
